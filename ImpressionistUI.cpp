...
//-------------------------------------------------------------
// Sets the way to input stroke direction 
// Called by the UI when a stroke direction is chosen
//-------------------------------------------------------------
...
//-----------------------------------------------------------
// Updates the width size to use from the value of the LineWidth
// slider
...
//-----------------------------------------------------------
// Updates the angle size to use from the value of the LineAngle
// slider
...
//-----------------------------------------------------------
// Updates alpha to use from the value of alpha
// slider
...
Fl_Menu_Item ImpressionistUI::StrokeDirectionMenu[NUM_STROKE_DIRECTION + 1] = {
	{ "Slider",				FL_ALT + 's', (Fl_Callback *)ImpressionistUI::cb_strokeDirection, (void *)STROKE_SLIDER},
	{ "Right Mouse",		FL_ALT + 'r', (Fl_Callback *)ImpressionistUI::cb_strokeDirection, (void *)STROKE_RIGHTMOUSE},
	{ "Brush direction",	FL_ALT + 'b', (Fl_Callback *)ImpressionistUI::cb_strokeDirection, (void *)STROKE_BRUSH_DIRECTION },
	{ "Gradient",			FL_ALT + 'g', (Fl_Callback *)ImpressionistUI::cb_strokeDirection, (void *)STROKE_GRADIENT },
	{ 0 }
};
...
ImpressionistUI::ImpressionistUI() {
	...
	m_brushDialog = new Fl_Window(400, 325, "Brush Dialog");
		...
		m_strokeTypeChoice = new Fl_Choice(50, 45 , 150, 25, "&Stroke Direction");
		m_strokeTypeChoice->user_data((void*)(this));	 // record self to be used by static callback functions
		m_strokeTypeChoice->menu(StrokeDirectionMenu);
		m_strokeTypeChoice->callback(cb_strokeDirection);
		...
		// Add line thickness/width slider to the dialog
